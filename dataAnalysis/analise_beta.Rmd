...
# zipf 0.4
rate_admission04 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use04 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud04 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type04 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic04 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless04 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic04 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless04 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc04 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc04 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson04 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Poisson', col_names=TRUE))
zipf04 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Zipf', col_names=TRUE))
times04 <- read.table("../dataAnalysis/data/beta/instance_x_standard_beta_01.dat", header = TRUE)
delay04 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_01.xlsx", sheet='Delay', col_names=TRUE))

# zipf 0.6
rate_admission06 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use06 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud06 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type06 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic06 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless06 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic06 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless06 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc06 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc06 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson06 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Poisson', col_names=TRUE))
zipf06 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Zipf', col_names=TRUE))
times06 <- read.table("../dataAnalysis/data/beta/instance_x_standard_beta_02.dat", header = TRUE)
delay06 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_02.xlsx", sheet='Delay', col_names=TRUE))

# zipf 0.8
rate_admission08 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use08 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud08 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type08 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic08 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless08 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic08 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless08 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc08 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc08 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson08 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Poisson', col_names=TRUE))
zipf08 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Zipf', col_names=TRUE))
times08 <- read.table("../dataAnalysis/data/beta/instance_x_standard_beta_03.dat", header = TRUE)
delay08 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_03.xlsx", sheet='Delay', col_names=TRUE))

# zipf 1.0
rate_admission1 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use1 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud1 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type1 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic1 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless1 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic1 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless1 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc1 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc1 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson1 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Poisson', col_names=TRUE))
zipf1 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Zipf', col_names=TRUE))
times1 <- read.table("../dataAnalysis/data/beta/instance_x_standard_beta_04.dat", header = TRUE)
delay1 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_04.xlsx", sheet='Delay', col_names=TRUE))

# zipf 1.2
rate_admission12 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use12 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud12 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type12 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic12 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless12 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic12 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless12 <- data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc12 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc12 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson12 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Poisson', col_names=TRUE))
zipf12 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Zipf', col_names=TRUE))
times12 <- read.table("../dataAnalysis/data/beta/instance_x_standard_beta_05.dat", header = TRUE)
delay12 = data.frame(read_excel("../dataAnalysis/data/beta/instance_x_standard_beta_05.xlsx", sheet='Delay', col_names=TRUE))
...
legend(x = "bottomright",
       legend = c(expression(paste(beta, " = ", 0.1)), expression(paste(beta, " = ", 0.2)),expression(paste(beta, " = ", 0.3)), expression(paste(beta, " = ", 0.4)),expression(paste(beta, " = ", 0.5))),
...
$\alpha : 0.1 =$ `r  round(rate_admission04$Rate_Admission,4) * 100`% -  `r rate_admission04$Admission_Requests`/`r rate_admission04$All_Requests`.

$\alpha : 0.2 =$ `r  round(rate_admission06$Rate_Admission,4) * 100`% -  `r rate_admission06$Admission_Requests`/`r rate_admission06$All_Requests`.

$\alpha : 0.3 =$ `r  round(rate_admission08$Rate_Admission,4) * 100`% -  `r rate_admission08$Admission_Requests`/`r rate_admission08$All_Requests`.

$\alpha : 0.4 =$ `r  round(rate_admission1$Rate_Admission,4) * 100`% -  `r rate_admission1$Admission_Requests`/`r rate_admission1$All_Requests`.

$\alpha : 0.5 =$ `r  round(rate_admission12$Rate_Admission,4) * 100`% -  `r rate_admission12$Admission_Requests`/`r rate_admission12$All_Requests`.


### Distribuição da Latência

```{r echo=FALSE, results=FALSE, warning=FALSE}
 type_zipf <- rep("0.1",length(delay04$Delay))
 d_04 <- data.frame(delay = c(delay04$Delay),
                           type = type_zipf,
                           stringsAsFactors = FALSE)
 type_zipf <- rep("0.2",length(delay06$Delay))
 d_06 <- data.frame(delay = c(delay06$Delay),
                           type = type_zipf,
                           stringsAsFactors = FALSE)
 type_zipf <- rep("0.3",length(delay08$Delay))
 d_08 <- data.frame(delay = c(delay08$Delay),
                           type = type_zipf,
                           stringsAsFactors = FALSE)
 type_zipf <- rep("0.4",length(delay1$Delay))
 d_1 <- data.frame(delay = c(delay1$Delay),
                           type = type_zipf,
                           stringsAsFactors = FALSE)

 type_zipf <- rep("0.5",length(delay12$Delay))
...
labs(colour = c(expression(paste(beta,":"))))+
theme_classic()+  
...
for (i in 1:n){
  server_use_n12 <- server_use1 %>% filter(server_use1$Event == i)
  ...
  ratio_server_use12 <- append(ratio_server_use1,ratio_server_use_n12)
...
d1_1 <- data.frame(event=c(cache_vs_cloud1$Event),
                           ratio_cache_hit = c(cache_vs_cloud1$Cache),
                           type = type_cache,
                           stringsAsFactors = FALSE)
type_cloud <- rep("Ratio Cache Miss",100)
d2_1 <- data.frame(event=c(cache_vs_cloud1$Event),
                           ratio_cache_hit = c(cache_vs_cloud1$Cloud),
                           type = type_cloud,
                           stringsAsFactors = FALSE)
type_server_use <- rep("Server Load",100)
d3_1 <- data.frame(event=c(rep(1:100,1)),
                           ratio_cache_hit = ratio_server_use1,
                           type = type_server_use,
                           stringsAsFactors = FALSE)

type_cache <- rep("Ratio Cache Hit",100)
d1_12 <- data.frame(event=c(cache_vs_cloud12$Event),
                           ratio_cache_hit = c(cache_vs_cloud12$Cache),
                           type = type_cache,
                           stringsAsFactors = FALSE)
type_cloud <- rep("Ratio Cache Miss",100)
d2_12 <- data.frame(event=c(cache_vs_cloud12$Event),
                           ratio_cache_hit = c(cache_vs_cloud12$Cloud),
                           type = type_cloud,
                           stringsAsFactors = FALSE)
type_server_use <- rep("Server Load",100)
...
df_1 <- bind_rows(d1_1,d3_1,d2_1)
df_12 <- bind_rows(d1_12,d3_12,d2_12)
```
