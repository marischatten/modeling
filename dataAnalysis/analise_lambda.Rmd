...
legend(x = "bottomright", 
       legend = c(expression(paste(lambda, " = ", 0.1)), expression(paste(lambda, " = ", 0.2)),expression(paste(lambda, " = ", 0.3))), 
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
x <- c(1:99)
y04 <- cache_vs_cloud06$Cache
y06 <- cache_vs_cloud06$Cache
y08 <- cache_vs_cloud06$Cache
y1 <- cache_vs_cloud06$Cache
y12 <- cache_vs_cloud06$Cache
plot(x,y04,col="#36393D", pch=16 , cex=1.3 , xlab="Events" , ylab="Utilização de Cache",type="o")
