...
# alpha 1
server_use1 <- data.frame(read_excel("../dataAnalysis/data/instance_6_avg20_n10_a05.xlsx", sheet='Server_Use', col_names=TRUE))
rate_admission1 <- data.frame(read_excel("../dataAnalysis/data/instance_6_avg20_n10_a05.xlsx", sheet='Rate_Admission', col_names=TRUE))
scattering1 <- data.frame(read_excel("../dataAnalysis/data/instance_6_avg20_n10_a05.xlsx", sheet='Scattering', col_names=TRUE))
load_links1 <- data.frame(read_excel("../dataAnalysis/data/instance_6_avg20_n10_a05.xlsx", sheet='Load_Links', col_names=TRUE))
times1 <- read.table("../dataAnalysis/data/instance_6_alpha1.dat", header = TRUE)

# alpha 0.5
server_use05 <- data.frame(read_excel("../dataAnalysis/data/instance_6_avg5_n40_a05.xlsx", sheet='Server_Use', col_names=TRUE))
rate_admission05 <- data.frame(read_excel("../dataAnalysis/data/instance_6_avg5_n40_a05.xlsx", sheet='Rate_Admission', col_names=TRUE))
scattering05 <- data.frame(read_excel("../dataAnalysis/data/instance_6_avg5_n40_a05.xlsx", sheet='Scattering', col_names=TRUE))
load_links05 <- data.frame(read_excel("../dataAnalysis/data/instance_6_avg5_n40_a05.xlsx", sheet='Load_Links', col_names=TRUE))
times05 <- read.table("../dataAnalysis/data/instance_6_alpha05.dat", header = TRUE)

# alpha 0
server_use0 <- data.frame(read_excel("../dataAnalysis/data/instance_6_alpha0.xlsx", sheet='Server_Use', col_names=TRUE))
rate_admission0 <- data.frame(read_excel("../dataAnalysis/data/instance_6_alpha0.xlsx", sheet='Rate_Admission', col_names=TRUE))
scattering0 <- data.frame(read_excel("../dataAnalysis/data/instance_6_alpha0.xlsx", sheet='Scattering', col_names=TRUE))
load_links0 <- data.frame(read_excel("../dataAnalysis/data/instance_6_alpha0.xlsx", sheet='Load_Links', col_names=TRUE))
times0 <- read.table("../dataAnalysis/data/instance_6_alpha0.dat", header = TRUE)
