...
$\alpha : 0.2 =$ `r  round(rate_admission02$Rate_Admission,4) * 100`% -  `r rate_admission02$Admission_Requests`/`r rate_admission02$All_Requests`.
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
 ...
 df <- rbind(d_02,d_04,d_06,d_08,d_1,d_12)
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
#join columns
df_02 <- bind_rows(d1_02,d3_02,d2_02)
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
ggplot(data_02, aes(fill=Metrics_02, y=hit_02, x=events_02)) + 
