...
# storage 0.2
paths02 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.2.xlsx", sheet='Requests', col_names=TRUE))
...
rtt02 =  data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.2.xlsx", sheet='RTT', col_names=TRUE))
# storage 0.4
paths04 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Requests', col_names=TRUE))
...
rtt04 =  data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='RTT', col_names=TRUE))

# storage 0.6
paths06 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.6.xlsx", sheet='Requests', col_names=TRUE))
...
#times06 <- read.table("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", header = TRUE)
delay06 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.6.xlsx", sheet='Delay', col_names=TRUE))
rtt06 =  data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.6.xlsx", sheet='RTT', col_names=TRUE))

# storage 0.8
paths08 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.8.xlsx", sheet='Requests', col_names=TRUE))
...
#times08 <- read.table("../dataAnalysis/data/storage/instance_x_storage_0.8.xlsx", header = TRUE)
delay08 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.8.xlsx", sheet='Delay', col_names=TRUE))
rtt08 =  data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.8.xlsx", sheet='RTT', col_names=TRUE))

# storage 1.0
paths1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Requests', col_names=TRUE))
rate_admission1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless1 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc1 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc1 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson1 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Poisson', col_names=TRUE))
zipf1 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Zipf', col_names=TRUE))
#times1 <- read.table("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", header = TRUE)
delay1 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Delay', col_names=TRUE))

# storage 1.2
paths12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Requests', col_names=TRUE))
rate_admission12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless12 <- data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc12 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc12 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson12 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Poisson', col_names=TRUE))
zipf12 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Zipf', col_names=TRUE))
#times12 <- read.table("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", header = TRUE)
delay12 = data.frame(read_excel("../dataAnalysis/data/storage/instance_x_storage_0.4.xlsx", sheet='Delay', col_names=TRUE))
```
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
if (save_pt){
  # ggsave(g1_server_load_sma,filename = "graph/pt/storage/storage_server_load_sma.png", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/pt/storage/storage_load_links_sma.png", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/pt/storage/storage_server_load.png", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/pt/storage/storage_load_links.png", dpi = 600)
  ggsave(g1,filename = "graph/pt/storage/storage02.pdf", dpi = 600)
  ggsave(g2,filename = "graph/pt/storage/storage04.pdf", dpi = 600)
  ggsave(g3,filename = "graph/pt/storage/storage06.pdf", dpi = 600)
  ggsave(g4,filename = "graph/pt/storage/storage08.pdf", dpi = 600)
  # ggsave(g1_server_load_sma,filename = "graph/pt/storage/storage_server_load_sma.pdf", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/pt/storage/storage_load_links_sma.pdf", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/pt/storage/storage_server_load.pdf", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/pt/storage/storage_load_links.pdf", dpi = 600)
  ggsave(g1,filename = "graph/pt/storage/storage02.png", dpi = 600)
  ggsave(g2,filename = "graph/pt/storage/storage04.png", dpi = 600)
  ggsave(g3,filename = "graph/pt/storage/storage06.png", dpi = 600)
  ggsave(g4,filename = "graph/pt/storage/storage08.png", dpi = 600)
}else{
  # ggsave(g1_server_load_sma,filename = "graph/storage/storage_server_load_sma.png", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/storage/storage_load_links_sma.png", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/storage/storage_server_load.png", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/storage/storage_load_links.png", dpi = 600)
  ggsave(g1,filename = "graph/storage/storage02.pdf", dpi = 600)
  ggsave(g2,filename = "graph/storage/storage04.pdf", dpi = 600)
  ggsave(g3,filename = "graph/storage/storage06.pdf", dpi = 600)
  ggsave(g4,filename = "graph/storage/storage08.pdf", dpi = 600)
  # ggsave(g1_server_load_sma,filename = "graph/storage/storage_server_load_sma.pdf", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/storage/storage_load_links_sma.pdf", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/storage/storage_server_load.pdf", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/storage/storage_load_links.pdf", dpi = 600)
  ggsave(g1,filename = "graph/storage/storage02.png", dpi = 600)
  ggsave(g2,filename = "graph/storage/storage04.png", dpi = 600)
  ggsave(g3,filename = "graph/storage/storage06.png", dpi = 600)
  ggsave(g4,filename = "graph/storage/storage08.png", dpi = 600)
}
```
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
if (save_pt){
  ggsave(g_delay,filename = "graph/pt/storage/storage_delay.pdf", dpi = 600)
  ggsave(g_delay,filename = "graph/pt/storage/storage_delay.png", dpi = 600)
}else{
  ggsave(g_delay,filename = "graph/storage/storage_delay.pdf", dpi = 600)
  ggsave(g_delay,filename = "graph/storage/storage_delay.png", dpi = 600)
}
```
...
```{r echo=FALSE, results=TRUE, warning=FALSE}
if (save_pt){
  ggsave(sum_hops_02,filename = "graph/pt/storage/sum_hops02.pdf", dpi = 600)
  ggsave(sum_hops_02,filename = "graph/pt/storage/sum_hops02.png", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/pt/storage/sum_hops04.pdf", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/pt/storage/sum_hops04.png", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/pt/storage/sum_hops06.pdf", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/pt/storage/sum_hops06.png", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/pt/storage/sum_hops08.pdf", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/pt/storage/sum_hops08.png", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/pt/storage/sum_hops1.pdf", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/pt/storage/sum_hops1.png", dpi = 600)
}else{
  ggsave(sum_hops_02,filename = "graph/storage/sum_hops02.pdf", dpi = 600)
  ggsave(sum_hops_02,filename = "graph/storage/sum_hops02.png", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/storage/sum_hops04.pdf", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/storage/sum_hops04.png", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/storage/sum_hops06.pdf", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/storage/sum_hops06.png", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/storage/sum_hops08.pdf", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/storage/sum_hops08.png", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/storage/sum_hops1.pdf", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/storage/sum_hops1.png", dpi = 600)
}
``` 
...
```{r echo=FALSE, results=TRUE, warning=FALSE}
if (save_pt){
  ggsave(load_network_02,filename = "graph/pt/storage/load_bh_fh02.pdf", dpi = 600)
  ggsave(load_network_02,filename = "graph/pt/storage/load_bh_fh02.png", dpi = 600)
  ggsave(load_network_04,filename = "graph/pt/storage/load_bh_fh04.pdf", dpi = 600)
  ggsave(load_network_04,filename = "graph/pt/storage/load_bh_fh04.png", dpi = 600)
  ggsave(load_network_06,filename = "graph/pt/storage/load_bh_fh06.pdf", dpi = 600)
  ggsave(load_network_06,filename = "graph/pt/storage/load_bh_fh06.png", dpi = 600)
  ggsave(load_network_08,filename = "graph/pt/storage/load_bh_fh08.pdf", dpi = 600)
  ggsave(load_network_08,filename = "graph/pt/storage/load_bh_fh08.png", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/pt/storage/load_bh_fh1.pdf", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/pt/storage/load_bh_fh1.png", dpi = 600)
}else{
  ggsave(load_network_02,filename = "graph/storage/load_bh_fh02.pdf", dpi = 600)
  ggsave(load_network_02,filename = "graph/storage/load_bh_fh02.png", dpi = 600)
  ggsave(load_network_04,filename = "graph/storage/load_bh_fh04.pdf", dpi = 600)
  ggsave(load_network_04,filename = "graph/storage/load_bh_fh04.png", dpi = 600)
  ggsave(load_network_06,filename = "graph/storage/load_bh_fh06.pdf", dpi = 600)
  ggsave(load_network_06,filename = "graph/storage/load_bh_fh06.png", dpi = 600)
  ggsave(load_network_08,filename = "graph/storage/load_bh_fh08.pdf", dpi = 600)
  ggsave(load_network_08,filename = "graph/storage/load_bh_fh08.png", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/storage/sum_hops1.pdf", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/storage/sum_hops1.png", dpi = 600)
}
``` 