...
save_pt = FALSE
# zipf 0.4
paths04 <- data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf04_lambda5fixo.xlsx", sheet='Requests', col_names=TRUE))
...
rtt04 =  data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf04_lambda5fixo.xlsx", sheet='RTT', col_names=TRUE))

# zipf 0.6
paths06 <- data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf06_lambda5fixo.xlsx", sheet='Requests', col_names=TRUE))
...
rtt06 =  data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf06_lambda5fixo.xlsx", sheet='RTT', col_names=TRUE))

# zipf 0.8
paths08 <- data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf08_lambda5fixo.xlsx", sheet='Requests', col_names=TRUE))
...
rtt08 =  data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf08_lambda5fixo.xlsx", sheet='RTT', col_names=TRUE))

# zipf 1.0
paths1 <- data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf10_lambda5fixo.xlsx", sheet='Requests', col_names=TRUE))
...
#times1 <- read.table("../dataAnalysis/data/zipf/instance_zipf08_lambda5fixo.xlsx", header = TRUE)
delay1 = data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf10_lambda5fixo.xlsx", sheet='Delay', col_names=TRUE))
rtt1 =  data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf10_lambda5fixo.xlsx", sheet='RTT', col_names=TRUE))

# zipf 1.2
paths12 <- data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf12_lambda5fixo.xlsx", sheet='Requests', col_names=TRUE))
...
rtt12 =  data.frame(read_excel("../dataAnalysis/data/zipf/instance_zipf12_lambda5fixo.xlsx", sheet='RTT', col_names=TRUE))
```
...
if (save_pt){
  ...
  # ggsave(g1_server_load,filename = "graph/pt/zipf/zipf_server_load.pdf", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/pt/zipf/zipf_load_links.pdf", dpi = 600)
  ...
  # ggsave(g1_server_load_sma,filename = "graph/pt/zipf/zipf_server_load_sma.png", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/pt/zipf/zipf_load_links_sma.png", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/pt/zipf/zipf_server_load.png", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/pt/zipf/zipf_load_links.png", dpi = 600)
  ...
  # ggsave(g1_server_load_sma,filename = "graph/zipf/zipf_server_load_sma.pdf", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/zipf/zipf_load_links_sma.pdf", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/zipf/zipf_server_load.pdf", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/zipf/zipf_load_links.pdf", dpi = 600)
  ...
  # ggsave(g1_server_load_sma,filename = "graph/zipf/zipf_server_load_sma.png", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/zipf/zipf_load_links_sma.png", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/zipf/zipf_server_load.png", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/zipf/zipf_load_links.png", dpi = 600)
...
```{r echo=FALSE, results=TRUE, warning=FALSE}
if (save_pt){
  # ggsave(sum_hops_02,filename = "graph/pt/zipf/sum_hops02.pdf", dpi = 600)
  # ggsave(sum_hops_02,filename = "graph/pt/zipf/sum_hops02.png", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/pt/zipf/sum_hops04.pdf", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/pt/zipf/sum_hops04.png", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/pt/zipf/sum_hops06.pdf", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/pt/zipf/sum_hops06.png", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/pt/zipf/sum_hops08.pdf", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/pt/zipf/sum_hops08.png", dpi = 600)
  ggsave(sum_hops_1,filename = "graph/pt/zipf/sum_hops1.pdf", dpi = 600)
  ggsave(sum_hops_1,filename = "graph/pt/zipf/sum_hops1.png", dpi = 600)
  ggsave(sum_hops_12,filename = "graph/pt/zipf/sum_hops12.pdf", dpi = 600)
  ggsave(sum_hops_12,filename = "graph/pt/zipf/sum_hops12.png", dpi = 600)
}else{
  # ggsave(sum_hops_02,filename = "graph/zipf/sum_hops02.pdf", dpi = 600)
  # ggsave(sum_hops_02,filename = "graph/zipf/sum_hops02.png", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/zipf/sum_hops04.pdf", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/zipf/sum_hops04.png", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/zipf/sum_hops06.pdf", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/zipf/sum_hops06.png", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/zipf/sum_hops08.pdf", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/zipf/sum_hops08.png", dpi = 600)
  ggsave(sum_hops_1,filename = "graph/zipf/sum_hops1.pdf", dpi = 600)
  ggsave(sum_hops_1,filename = "graph/zipf/sum_hops1.png", dpi = 600)
  ggsave(sum_hops_12,filename = "graph/zipf/sum_hops12.pdf", dpi = 600)
  ggsave(sum_hops_12,filename = "graph/zipf/sum_hops12.png", dpi = 600)
}
``` 
...
```{r echo=FALSE, results=TRUE, warning=FALSE}
if (save_pt){
  ggsave(load_network_04,filename = "graph/pt/zipf/load_bh_fh04.pdf", dpi = 600)
  ggsave(load_network_04,filename = "graph/pt/zipf/load_bh_fh04.png", dpi = 600)
  ggsave(load_network_06,filename = "graph/pt/zipf/load_bh_fh06.pdf", dpi = 600)
  ggsave(load_network_06,filename = "graph/pt/zipf/load_bh_fh06.png", dpi = 600)
  ggsave(load_network_08,filename = "graph/pt/zipf/load_bh_fh08.pdf", dpi = 600)
  ggsave(load_network_08,filename = "graph/pt/zipf/load_bh_fh08.png", dpi = 600)
  ggsave(load_network_1,filename = "graph/pt/zipf/load_bh_fh10.pdf", dpi = 600)
  ggsave(load_network_1,filename = "graph/pt/zipf/load_bh_fh10.png", dpi = 600)
  ggsave(load_network_12,filename = "graph/pt/zipf/load_bh_fh12.pdf", dpi = 600)
  ggsave(load_network_12,filename = "graph/pt/zipf/load_bh_fh12.png", dpi = 600)
}else{
  ggsave(load_network_04,filename = "graph/zipf/load_bh_fh04.pdf", dpi = 600)
  ggsave(load_network_04,filename = "graph/zipf/load_bh_fh04.png", dpi = 600)
  ggsave(load_network_06,filename = "graph/zipf/load_bh_fh06.pdf", dpi = 600)
  ggsave(load_network_06,filename = "graph/zipf/load_bh_fh06.png", dpi = 600)
  ggsave(load_network_08,filename = "graph/zipf/load_bh_fh08.pdf", dpi = 600)
  ggsave(load_network_08,filename = "graph/zipf/load_bh_fh08.png", dpi = 600)
  ggsave(load_network_1,filename = "graph/zipf/load_bh_fh10.pdf", dpi = 600)
  ggsave(load_network_1,filename = "graph/zipf/load_bh_fh10.png", dpi = 600)
  ggsave(load_network_12,filename = "graph/zipf/load_bh_fh12.pdf", dpi = 600)
  ggsave(load_network_12,filename = "graph/zipf/load_bh_fh12.png", dpi = 600)
}
``` 
