...
# alpha 0.5
server_use05 <- data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Server_Use', col_names=TRUE))
rate_admission05 <- data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Rate_Admission', col_names=TRUE))
scattering_optic05 <- data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless05 <- data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic05 <- data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless05 <- data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc05 = data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc05 = data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson05 = data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Poisson', col_names=TRUE))
zipf05 = data.frame(read_excel("../dataAnalysis/data/instance_4_1.xlsx", sheet='Zipf', col_names=TRUE))
times05 <- read.table("../dataAnalysis/data/instance_4_1.dat", header = TRUE)
