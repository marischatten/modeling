...
# storage 0.2
paths02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Requests', col_names=TRUE))
rate_admission02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless02 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc02 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc02 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson02 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Poisson', col_names=TRUE))
zipf02 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Zipf', col_names=TRUE))
#times02 <- read.table("/dataAnalysisdata/gamma_6/storage/instance_x_storage_0.2.dat", header = TRUE)
delay02 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Delay', col_names=TRUE))
rtt02 =  data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='RTT', col_names=TRUE))
# storage 0.4
paths04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Requests', col_names=TRUE))
rate_admission04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless04 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc04 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc04 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson04 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Poisson', col_names=TRUE))
zipf04 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Zipf', col_names=TRUE))
#times04 <- read.table("/dataAnalysisdata/gamma_6/storage/instance_x_storage_0.4.dat", header = TRUE)
delay04 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='Delay', col_names=TRUE))
rtt04 =  data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage04.xlsx", sheet='RTT', col_names=TRUE))

# storage 0.6
paths06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Requests', col_names=TRUE))
rate_admission06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless06 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc06 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc06 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson06 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Poisson', col_names=TRUE))
zipf06 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Zipf', col_names=TRUE))
#times06 <- read.table("/dataAnalysisdata/gamma_6/storage/instance_x_storage_0.4.xlsx", header = TRUE)
delay06 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='Delay', col_names=TRUE))
rtt06 =  data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage06.xlsx", sheet='RTT', col_names=TRUE))

# storage 0.8
paths08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Requests', col_names=TRUE))
rate_admission08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless08 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc08 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc08 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson08 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Poisson', col_names=TRUE))
zipf08 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Zipf', col_names=TRUE))
#times08 <- read.table("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", header = TRUE)
delay08 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='Delay', col_names=TRUE))
rtt08 =  data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage08.xlsx", sheet='RTT', col_names=TRUE))

# storage 1.0
paths1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Requests', col_names=TRUE))
rate_admission1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless1 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc1 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc1 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson1 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Poisson', col_names=TRUE))
zipf1 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Zipf', col_names=TRUE))
#times1 <- read.table("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", header = TRUE)
delay1 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Delay', col_names=TRUE))

# storage 1.2
paths12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Requests', col_names=TRUE))
rate_admission12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless12 <- data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc12 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc12 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson12 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Poisson', col_names=TRUE))
zipf12 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Zipf', col_names=TRUE))
#times12 <- read.table("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", header = TRUE)
delay12 = data.frame(read_excel("data/gamma_6/network_aware/storage/instance_x_standard_storage02.xlsx", sheet='Delay', col_names=TRUE))
```
...
if (save_pt){
  ...
  ggsave(g_line_standard,filename = "graph/network_aware/pt/standard.png", dpi = 600)
}else{
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
g_delay <- ggplot(df_delay,) +
  geom_boxplot(alpha=0.8,aes(x=type, y=delay, group=type, color=type,fill=type)) + 
  theme_bw()+
...
```{r}
# write.csv(cache_vs_cloud04$Cache, "cache_hit", row.names = FALSE)
# write.csv(cache_vs_cloud04$Cloud, "cache_miss", row.names = FALSE)
# write.csv(ratio_server_use04, "stroage_load", row.names = FALSE)
# write.csv(load_network_04, "load_network", row.names = FALSE)
# write.csv(sum_hops_04, "sum_hops.csv", row.names = FALSE)
# 
# 
# 
# sum04_cloud
