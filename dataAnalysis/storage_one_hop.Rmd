...
# storage 0.2
paths02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless02 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc02 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc02 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson02 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf02 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times02 <- read.table("/dataAnalysisdata/storage/instance_x_standard_storage02_no_cooperation.xlsx", header = TRUE)
delay02 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt02 =  data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage02_one_hop.xlsx", sheet='RTT', col_names=TRUE))
# storage 0.4
paths04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless04 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc04 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc04 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson04 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf04 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times04 <- read.table("/dataAnalysisdata/storage/instance_x_storage_0.4.dat", header = TRUE)
delay04 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt04 =  data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage04_one_hop.xlsx", sheet='RTT', col_names=TRUE))

# storage 0.6
paths06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless06 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc06 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc06 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson06 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf06 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times06 <- read.table("/dataAnalysisdata/storage/instance_x_storage_0.4.xlsx", header = TRUE)
delay06 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt06 =  data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage06_one_hop.xlsx", sheet='RTT', col_names=TRUE))

# storage 0.8
paths08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless08 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc08 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc08 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson08 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf08 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times08 <- read.table("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", header = TRUE)
delay08 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt08 =  data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='RTT', col_names=TRUE))

# storage 1.0
paths1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless1 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc1 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc1 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson1 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf1 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times1 <- read.table("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", header = TRUE)
delay1 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Delay', col_names=TRUE))

# storage 1.2
paths12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless12 <- data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc12 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc12 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson12 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf12 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times12 <- read.table("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", header = TRUE)
delay12 = data.frame(read_excel("data/gamma_6/one_hop/storage/instance_x_standard_storage08_one_hop.xlsx", sheet='Delay', col_names=TRUE))
```
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
if (save_pt){
  # ggsave(g1_server_load_sma,filename = "graph/one_hop/pt/storage/storage_server_load_sma.png", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/one_hop/pt/storage/storage_load_links_sma.png", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/one_hop/pt/storage/storage_server_load.png", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/one_hop/pt/storage/storage_load_links.png", dpi = 600)
  ggsave(g1,filename = "graph/one_hop/pt/storage/storage02.pdf", dpi = 600)
  ggsave(g2,filename = "graph/one_hop/pt/storage/storage04.pdf", dpi = 600)
  ggsave(g3,filename = "graph/one_hop/pt/storage/storage06.pdf", dpi = 600)
  ggsave(g4,filename = "graph/one_hop/pt/storage/storage08.pdf", dpi = 600)
  # ggsave(g1_server_load_sma,filename = "graph/one_hop/pt/storage/storage_server_load_sma.pdf", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/one_hop/pt/storage/storage_load_links_sma.pdf", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/one_hop/pt/storage/storage_server_load.pdf", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/one_hop/pt/storage/storage_load_links.pdf", dpi = 600)
  ggsave(g1,filename = "graph/one_hop/pt/storage/storage02.png", dpi = 600)
  ggsave(g2,filename = "graph/one_hop/pt/storage/storage04.png", dpi = 600)
  ggsave(g3,filename = "graph/one_hop/pt/storage/storage06.png", dpi = 600)
  ggsave(g4,filename = "graph/one_hop/pt/storage/storage08.png", dpi = 600)
    ggsave(g_line_standard,filename = "graph/one_hop/pt/standard.png", dpi = 600)
}else{
  # ggsave(g1_server_load_sma,filename = "graph/one_hop/storage/storage_server_load_sma.png", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/one_hop/storage/storage_load_links_sma.png", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/one_hop/storage/storage_server_load.png", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/one_hop/storage/storage_load_links.png", dpi = 600)
  ggsave(g1,filename = "graph/one_hop/en/storage/storage02.pdf", dpi = 600)
  ggsave(g2,filename = "graph/one_hop/en/storage/storage04.pdf", dpi = 600)
  ggsave(g3,filename = "graph/one_hop/en/storage/storage06.pdf", dpi = 600)
  ggsave(g4,filename = "graph/one_hop/en/storage/storage08.pdf", dpi = 600)
  # ggsave(g1_server_load_sma,filename = "graph/one_hop/storage/storage_server_load_sma.pdf", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/one_hop/storage/storage_load_links_sma.pdf", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/one_hop/storage/storage_server_load.pdf", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/one_hop/storage/storage_load_links.pdf", dpi = 600)
  ggsave(g1,filename = "graph/one_hop/en/storage/storage02.png", dpi = 600)
  ggsave(g2,filename = "graph/one_hop/en/storage/storage04.png", dpi = 600)
  ggsave(g3,filename = "graph/one_hop/en/storage/storage06.png", dpi = 600)
  ggsave(g4,filename = "graph/one_hop/en/storage/storage08.png", dpi = 600)
...
```{r echo=FALSE, results=FALSE, warning=FALSE}
if (save_pt){
  ggsave(g_delay,filename = "graph/one_hop/pt/storage/storage_delay.pdf", dpi = 600)
  ggsave(g_delay,filename = "graph/one_hop/pt/storage/storage_delay.png", dpi = 600)
}else{
  ggsave(g_delay,filename = "graph/one_hop/en/storage/storage_delay.pdf", dpi = 600)
  ggsave(g_delay,filename = "graph/one_hop/en/storage/storage_delay.png", dpi = 600)
}
```
...
```{r echo=FALSE, results=TRUE, warning=FALSE}
min(cache_vs_cloud04$Cloud)
max(cache_vs_cloud04$Cache)
...
```{r echo=FALSE, results=TRUE, warning=FALSE}
if (save_pt){
  ggsave(sum_hops_02,filename = "graph/one_hop/pt/storage/sum_hops02.pdf", dpi = 600)
  ggsave(sum_hops_02,filename = "graph/one_hop/pt/storage/sum_hops02.png", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/one_hop/pt/storage/sum_hops04.pdf", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/one_hop/pt/storage/sum_hops04.png", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/one_hop/pt/storage/sum_hops06.pdf", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/one_hop/pt/storage/sum_hops06.png", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/one_hop/pt/storage/sum_hops08.pdf", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/one_hop/pt/storage/sum_hops08.png", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/one_hop/pt/storage/sum_hops1.pdf", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/one_hop/pt/storage/sum_hops1.png", dpi = 600)
}else{
  ggsave(sum_hops_02,filename = "graph/one_hop/en/storage/sum_hops02.pdf", dpi = 600)
  ggsave(sum_hops_02,filename = "graph/one_hop/en/storage/sum_hops02.png", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/one_hop/en/storage/sum_hops04.pdf", dpi = 600)
  ggsave(sum_hops_04,filename = "graph/one_hop/en/storage/sum_hops04.png", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/one_hop/en/storage/sum_hops06.pdf", dpi = 600)
  ggsave(sum_hops_06,filename = "graph/one_hop/en/storage/sum_hops06.png", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/one_hop/en/storage/sum_hops08.pdf", dpi = 600)
  ggsave(sum_hops_08,filename = "graph/one_hop/en/storage/sum_hops08.png", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/one_hop/storage/sum_hops1.pdf", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/one_hop/storage/sum_hops1.png", dpi = 600)
}
``` 
...
# load_network_1 <- plot_graph/one_hops_network_load(df_load_1,save_pt)
# load_network_12 <- plot_graph/one_hops_network_load(df_load_12,save_pt)
``` 
...
```{r echo=FALSE, results=TRUE, warning=FALSE}
if (save_pt){
  ggsave(load_network_02,filename = "graph/one_hop/pt/storage/load_bh_fh02.pdf", dpi = 600)
  ggsave(load_network_02,filename = "graph/one_hop/pt/storage/load_bh_fh02.png", dpi = 600)
  ggsave(load_network_04,filename = "graph/one_hop/pt/storage/load_bh_fh04.pdf", dpi = 600)
  ggsave(load_network_04,filename = "graph/one_hop/pt/storage/load_bh_fh04.png", dpi = 600)
  ggsave(load_network_06,filename = "graph/one_hop/pt/storage/load_bh_fh06.pdf", dpi = 600)
  ggsave(load_network_06,filename = "graph/one_hop/pt/storage/load_bh_fh06.png", dpi = 600)
  ggsave(load_network_08,filename = "graph/one_hop/pt/storage/load_bh_fh08.pdf", dpi = 600)
  ggsave(load_network_08,filename = "graph/one_hop/pt/storage/load_bh_fh08.png", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/one_hop/pt/storage/load_bh_fh1.pdf", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/one_hop/pt/storage/load_bh_fh1.png", dpi = 600)
}else{
  ggsave(load_network_02,filename = "graph/one_hop/en/storage/load_bh_fh02.pdf", dpi = 600)
  ggsave(load_network_02,filename = "graph/one_hop/en/storage/load_bh_fh02.png", dpi = 600)
  ggsave(load_network_04,filename = "graph/one_hop/en/storage/load_bh_fh04.pdf", dpi = 600)
  ggsave(load_network_04,filename = "graph/one_hop/en/storage/load_bh_fh04.png", dpi = 600)
  ggsave(load_network_06,filename = "graph/one_hop/en/storage/load_bh_fh06.pdf", dpi = 600)
  ggsave(load_network_06,filename = "graph/one_hop/en/storage/load_bh_fh06.png", dpi = 600)
  ggsave(load_network_08,filename = "graph/one_hop/en/storage/load_bh_fh08.pdf", dpi = 600)
  ggsave(load_network_08,filename = "graph/one_hop/en/storage/load_bh_fh08.png", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/one_hop/storage/sum_hops1.pdf", dpi = 600)
  # ggsave(sum_hops_1,filename = "graph/one_hop/storage/sum_hops1.png", dpi = 600)
}
``` 