...
save_pt = FALSE
# zipf 0.4
paths04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless04 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc04 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc04 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson04 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Poisson', col_names=TRUE))
zipf04 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Zipf', col_names=TRUE))
#times04 <- read.table("../dataAnalysis/data/zipf/instance_zipf04_lambda5fixo.dat", header = TRUE)
delay04 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Delay', col_names=TRUE))
rtt04 =  data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='RTT', col_names=TRUE))

# zipf 0.6
paths06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless06 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc06 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc06 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson06 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Poisson', col_names=TRUE))
zipf06 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Zipf', col_names=TRUE))
#times06 <- read.table("../dataAnalysis/data/zipf/instance_zipf06_lambda5fixo.dat", header = TRUE)
delay06 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Delay', col_names=TRUE))
rtt06 =  data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='RTT', col_names=TRUE))

# zipf 0.8
paths08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless08 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc08 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc08 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson08 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Poisson', col_names=TRUE))
zipf08 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Zipf', col_names=TRUE))
#times08 <- read.table("../dataAnalysis/data/zipf/instance_zipf08_lambda5fixo.dat", header = TRUE)
delay08 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='Delay', col_names=TRUE))
rtt08 =  data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf08_multihop.xlsx", sheet='RTT', col_names=TRUE))

# zipf 1.0
paths1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless1 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc1 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc1 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson1 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Poisson', col_names=TRUE))
zipf1 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Zipf', col_names=TRUE))
#times1 <- read.table("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", header = TRUE)
delay1 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='Delay', col_names=TRUE))
rtt1 =  data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf04_multihop.xlsx", sheet='RTT', col_names=TRUE))

# zipf 1.2
paths12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless12 <- data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc12 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc12 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson12 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Poisson', col_names=TRUE))
zipf12 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Zipf', col_names=TRUE))
#times12 <- read.table("../dataAnalysis/data/zipf/instance_zipf12_lambda5fixo.dat", header = TRUE)
delay12 = data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='Delay', col_names=TRUE))
rtt12 =  data.frame(read_excel("data/multi_hop/zipf/instance_x_standard_zipf12_multihop.xlsx", sheet='RTT', col_names=TRUE))
```
...
if (save_pt){
  ...
  # ggsave(g1_server_load,filename = "graph/multi_hop/pt/zipf/zipf_server_load.pdf", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/multi_hop/pt/zipf/zipf_load_links.pdf", dpi = 600)
  ...
  # ggsave(g1_server_load_sma,filename = "graph/multi_hop/pt/zipf/zipf_server_load_sma.png", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/multi_hop/pt/zipf/zipf_load_links_sma.png", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/multi_hop/pt/zipf/zipf_server_load.png", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/multi_hop/pt/zipf/zipf_load_links.png", dpi = 600)
  ...
  # ggsave(g1_server_load_sma,filename = "graph/multi_hop/en/zipf/zipf_server_load_sma.pdf", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/multi_hop/en/zipf/zipf_load_links_sma.pdf", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/multi_hop/en/zipf/zipf_server_load.pdf", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/multi_hop/en/zipf/zipf_load_links.pdf", dpi = 600)
  ...
  # ggsave(g1_server_load_sma,filename = "graph/multi_hop/en/zipf/zipf_server_load_sma.png", dpi = 600)
  # ggsave(g2_load_links_sma,filename = "graph/multi_hop/en/zipf/zipf_load_links_sma.png", dpi = 600)
  # ggsave(g1_server_load,filename = "graph/multi_hop/en/zipf/zipf_server_load.png", dpi = 600)
  # ggsave(g2_load_links,filename = "graph/multi_hop/en/zipf/zipf_load_links.png", dpi = 600)
...
```{r echo=FALSE, results=TRUE, warning=FALSE}
if (save_pt){
  # ggsave(sum_hops_02,filename = "graph/multi_hop/pt/zipf/sum_hops02.pdf", dpi = 600)
  # ggsave(sum_hops_02,filename = "graph/multi_hop/pt/zipf/sum_hops02.png", dpi = 600)
  ...
  # ggsave(sum_hops_02,filename = "graph/multi_hop/en/zipf/sum_hops02.pdf", dpi = 600)
  # ggsave(sum_hops_02,filename = "graph/multi_hop/en/zipf/sum_hops02.png", dpi = 600)
