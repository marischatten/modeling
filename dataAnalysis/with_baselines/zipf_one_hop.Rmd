...
save_pt = FALSE
# zipf 0.4
paths04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless04 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc04 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc04 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson04 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf04 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times04 <- read.table("../dataAnalysis/data/zipf/instance_zipf04_lambda5fixo.dat", header = TRUE)
delay04 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt04 =  data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='RTT', col_names=TRUE))

# zipf 0.6
paths06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless06 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc06 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc06 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson06 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf06 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times06 <- read.table("../dataAnalysis/data/zipf/instance_zipf06_lambda5fixo.dat", header = TRUE)
delay06 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt06 =  data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='RTT', col_names=TRUE))

# zipf 0.8
paths08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless08 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc08 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc08 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson08 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf08 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times08 <- read.table("../dataAnalysis/data/zipf/instance_zipf08_lambda5fixo.dat", header = TRUE)
delay08 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt08 =  data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf08_one_hop.xlsx", sheet='RTT', col_names=TRUE))

# zipf 1.0
paths1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless1 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc1 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc1 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson1 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf1 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times1 <- read.table("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", header = TRUE)
delay1 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt1 =  data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf04_one_hop.xlsx", sheet='RTT', col_names=TRUE))

# zipf 1.2
paths12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Requests', col_names=TRUE))
rate_admission12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Rate_Admission', col_names=TRUE))
server_use12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Server_Use', col_names=TRUE))
cache_vs_cloud12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='CacheVsCloud', col_names=TRUE))
server_use_by_type12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Server_Use_By_Type', col_names=TRUE))
scattering_optic12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Scattering_Optic', col_names=TRUE))
scattering_wireless12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Scattering_Wireless', col_names=TRUE))
load_links_optic12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Load_Links_Optic', col_names=TRUE))
load_links_wireless12 <- data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Load_Links_Wireless', col_names=TRUE))
path_Realloc12 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Paths_Reallocation', col_names=TRUE))
host_Realloc12 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Hosts_Reallocation', col_names=TRUE))

poisson12 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Poisson', col_names=TRUE))
zipf12 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Zipf', col_names=TRUE))
#times12 <- read.table("../dataAnalysis/data/zipf/instance_zipf12_lambda5fixo.dat", header = TRUE)
delay12 = data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='Delay', col_names=TRUE))
rtt12 =  data.frame(read_excel("data/one_hop/zipf/instance_x_standard_zipf12_one_hop.xlsx", sheet='RTT', col_names=TRUE))
```
